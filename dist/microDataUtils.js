...
exports.generateOpenUrl = exports.bibToSchema = void 0;
...
exports.bibToSchema = bibToSchema;
...
const generateOpenUrl = (citations = []) => {
  /**
  ...
  data.push(addPropToCOinSData('url_ver', 'Z39.88-2004')); // data.push( addPropToCOinSData( 'url_ctx_fmt', 'info:ofi/fmt:kev:mtx:ctx' ) );
  ...
  if (citation.type === 'article') {
    ...
    data = translate(data, citation, bookMap); // data.push( addPropToCOinSData( 'rft.genre', 'book' ) );
...
exports.generateOpenUrl = generateOpenUrl;